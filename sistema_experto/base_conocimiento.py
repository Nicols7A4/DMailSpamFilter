...
SPAM_WORDS = {
    # Marketing y Ofertas
    "oferta", "gratis", "premio", "descuento", "gana", "click", "clic", "promoción", "bono", "cupón", "gana",
    # Urgencia y Miedo
    "urgente", "urgent", "limitado", "actividad sospechosa", "suspendida", "bloqueada", "verificación", "verifica",
    # Financiero y Cripto
    "dinero", "transferencia", "ganador", "lotería", "préstamo", "herencia", "ingresos pasivos",
    "bitcoin", "cripto", "nft", "airdrop", "wallet",
    # Phishing y Marcas Falsas
    "PayPal", "Amazon", "Netflix", "Apple", "desbloquear", "datos", "siguiente", "enlace",
    # Contenido para Adultos (simplificado)
    "xxx"
}
